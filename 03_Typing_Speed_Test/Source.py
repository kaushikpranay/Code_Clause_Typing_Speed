...
class Game:
    def __init__(self):
        ...
        self.wpm = 0
        self.end = False
        self.HEAD_C = (0, 213, 102)
        self.TEXT_C = (255, 255, 255)
        self.RESULT_C = (255, 70, 70)

        pygame.init()
        self.open_img = pygame.image.load("pexels-markus-spiske-177598.jpg")
        self.open_img = pygame.transform.scale(self.open_img, (self.w, self.h))

        self.bg = pygame.image.load("download.jpeg")
        self.bg = pygame.transform.scale(self.bg, (750, 500))

        self.screen = pygame.display.set_mode((self.w, self.h))
        pygame.display.set_caption("Python Typing Test")
